...
**Beta v1.2.1** — A professional, modular audio metering and mastering analysis suite built with C++20 and JUCE 8.
...
See [CHANGELOG.md](./CHANGELOG.md) for the full version history, including the Beta v1.2.1 Phase Scope hotfix and the Beta v1.2.0 calibration audit.
...
- **Phase Scope**: Goniometer radar with Lissajous decaying persistence traces (0.75 alpha for snappier feel), polar graticule, and correlation stat-tiles. *(Phase 10: WASAPI freeze bug fixed; Phase 10.4 hotfix in v1.2.1 corrected a display regression introduced by that fix.)*
...
1. Extract `FF360Meter_v1.2.1-beta_Windows_x64.zip`.
...
1. Extract `FF360Meter_v1.2.1-beta_macOS_Universal.zip`.

...
**Version**: `Beta v1.2.0`  
**Release Date & Time**: `August 14, 2026 — 07:10 CDT`  
...
The **ff360_labs Modular Audio Meter** is a pre-release beta of an extensible, hardware-styled audio analysis and mastering suite built with **C++20** and **JUCE 8.0.4**. Beta v1.2.0 closes Phase 10 — a dedicated calibration audit, platform stability, and UI consolidation sprint.
...
- About dialog now shows `Beta v1.2.0 (Aug 14 2026)`.
...
### macOS 12 and Later (Apple Silicon & Intel) — Beta v1.2.0
